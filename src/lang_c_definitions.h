...
{
	LangC_TypeKind_Char,
	LangC_TypeKind_SignedChar,
	LangC_TypeKind_UnsignedChar,
	
	// NOTE(ljre): Those are signed by default.
	LangC_TypeKind_ShortInt,
	LangC_TypeKind_Int,
	LangC_TypeKind_LongInt,
	LangC_TypeKind_LongLongInt,
	
	LangC_TypeKind_UShortInt,
	LangC_TypeKind_UInt,
	LangC_TypeKind_ULongInt,
	LangC_TypeKind_ULongLongInt,
	
	LangC_TypeKind_Struct,
	LangC_TypeKind_Union,
	LangC_TypeKind_Enum,
	LangC_TypeKind_Alias, // typedef
	
	LangC_TypeKind_Pointer,
	LangC_TypeKind_Array,
	LangC_TypeKind_VariableLengthArray,
	LangC_TypeKind_Function,
}
typedef LangC_TypeKind;

struct LangC_Type typedef LangC_Type;
struct LangC_Symbol typedef LangC_Symbol;
struct LangC_Node typedef LangC_Node;

// NOTE(ljre): 'LangC_Type' objects are unique. They will always live in the 'persistent_arena'.
struct LangC_Type
{
	LangC_TypeKind kind;
	...
	union
	{
		LangC_Type* ptr_to;
		LangC_Type* array_of;
		LangC_Type* func_returns;
	};
	
	LangC_Node* vla_length_expr;
	uint64 length;
	LangC_Type* params;
};
...
struct LangC_Symbol
{
	// NOTE(ljre): This is a circular linked-list
	LangC_Symbol* next;
	LangC_Symbol* previous;
	...
	{
		LangC_Symbol* locals;
		int32 value; // NOTE(ljre): for enum
	};
};
...
struct LangC_Node
{
	...
	LangC_Type* resolved_type;
	LangC_Symbol* resolved_symbol;
	bool32 can_be_evaluated_at_compile_time;
};
